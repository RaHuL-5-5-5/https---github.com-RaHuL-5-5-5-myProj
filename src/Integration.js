  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content rounded-4 shadow">
      <div class="modal-body p-5">
        ...
        <button type="button" class="btn btn-lg btn-primary mt-2 w-100" data-bs-dismiss="modal">Great, thanks!</button>

        <button type="button" class="btn btn-lg btn-primary mt-1 w-100" data-bs-dismiss="modal">Great, thanks!</button>
      </div>
    </div>
  </div>
</div>
